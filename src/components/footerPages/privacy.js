...
export default function privacy() {
  return (
    <section className="container">
      ...
      <h2 className={style.footer__heading}><strong>Privacy Policy</strong></h2>
      </div>
      <h1>Privacy Policy for astrotalk</h1>

      <p>
        At www.astrotalk.com, accessible from www.astrotalk.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        www.astrotalk.com and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in www.astrotalk.com. This policy is not
      ...
      <p>
        www.astrotalk.com follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, www.astrotalk.com uses 'cookies'. These cookies
      ...
      <p>
        ...
        advertisements and links that appear on www.astrotalk.com, which are
      ...
      <p>
        Note that www.astrotalk.com has no access to or control over these
      ...
      <p>
        www.astrotalk.com's Privacy Policy does not apply to other advertisers
      ...
      <p>
        www.astrotalk.com does not knowingly collect any Personal Identifiable
